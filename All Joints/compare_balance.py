...
from rl.residual_env import ResidualEnvConfig, MiniArmResidualEnv
...
def run_phase_c_env(agent, episodes: int, model_path: str) -> float:
    """Run the training-phase-C residual env configuration."""
...
def main():
    ...
    print("Running phase_C residual_env episodes...")
    phase_c_avg = run_phase_c_env(agent, args.episodes, model_path)
    print(f"phase_C residual_env avg balance_count over {args.episodes} eps: {phase_c_avg:.2f}")
